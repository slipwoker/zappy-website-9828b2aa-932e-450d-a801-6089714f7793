document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (type === 'tel' || name.toLowerCase().includes('phone') || name.toLowerCase().includes('tel')) {
        ...
        if (!phoneRegex.test(value)) {
          showFieldError(field, getErrorMessage('phone', field));
          isValid = false;
          if (!firstInvalidField) firstInvalidField = field;
          return;
        }
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (value.length < min) {
          showFieldError(field, getErrorMessage('minlength', field, min));
          isValid = false;
          if (!firstInvalidField) firstInvalidField = field;
          return;
        }
      ...
      if (field.hasAttribute('maxlength')) {
        ...
        if (value.length > max) {
          showFieldError(field, getErrorMessage('maxlength', field, max));
          isValid = false;
          if (!firstInvalidField) firstInvalidField = field;
          return;
        }
  ...
  function getErrorMessage(type, field, param) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מונדר חליחל משרד עורכי דין, גישור ונוטריון משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '9828b2aa-932e-450d-a801-6089714f7793',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '9828b2aa-932e-450d-a801-6089714f7793';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9828b2aa-932e-450d-a801-6089714f7793';
